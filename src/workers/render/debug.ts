...
/**
 * Debug - Worker-side debug state management
 *
...
export default class Debug {
  ...
  private targets: Map<string, { obj: Record<string, unknown>; prop: string }> = new Map();
   ...
   */
  registerTarget(id: string, obj: Record<string, unknown>, prop: string): void {
...
class DebugUI {
  ...
  addFolder(options: { title: string }): DebugFolder {
    return new DebugFolder(this.debug, options.title);
  }
}
